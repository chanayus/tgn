    ...
    <nav id="navbar" class="absolute top-0 z-30 flex items-center w-full h-24 text-white">
      <div class="flex items-center justify-between w-full main-container">
        <section class="flex-1 flex items-center gap-x-6">
          ...
          <a href="" class="border px-2.5 py-1 md:block hidden hover:bg-black hover:text-white hover:border-black">
            Gastronomy Academy
          </a>
        </section>
        ...
        <section class="flex-1 flex justify-end items-center gap-x-6">
          <div class="space-x-4 md:block hidden">
            ...
            <a href="" class="px-2 border-b hover:text-black hover:border-black">EN</a>
          </div>
