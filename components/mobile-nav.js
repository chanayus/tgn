        ...
        <div id="mobile-nav-top" class="flex items-center w-full">
          <div class="flex items-center justify-between w-full main-container">
            <section class="flex-1 flex items-center gap-x-6">
              <button id="mobile-nav-menu-close" class="[&:hover_rect]:fill-black">
              ...
              <a href="" class="border border-gold px-2.5 py-1 md:block hidden hover:border-black hover:text-black transition-colors">
                Gastronomy Academy
              </a>
            </section>
            ...
            <section class="flex-1 flex justify-end items-center gap-x-6">
              <div class="space-x-4 md:block hidden">
                <a href="" class="px-2 hover:text-black hover:border-black">TH</a>
                <a href="" class="px-2 border-b border-gold hover:text-black hover:border-black">EN</a>
              </div>
              <button class="[&:hover_path]:stroke-black">
          ...
          <section class="flex-1 flex flex-col">
            <div id="mobile-menu-list" class="overflow-y-auto overflow-x-hidden lg:flex-[1_1_0] lg:pr-4 pr-1 ">
              <div class="collapsible border-b border-gold">
                ...
                <div class="collapsible-content-wrapper">
                  <div class="collapsible-content gap-y-6 text-xl">
                    <a href="../thailand-gastronomy-network.html">Thailand Gastronomy Network</a>
              ...
              <div class="collapsible border-b border-gold">
                ...
                <div class="collapsible-content-wrapper">
                  <div class="collapsible-content gap-y-6 text-xl">
                    <a href="../gastronomy-academy.html">Gastronomy Academy (E-Learning Platform)</a>
                    <a href="../food-learning-and-workshop.html">Sustainable Food Learning Journey and Workshop</a>
                    <a href="../gastronomy-trail-and-visit.html">Gastronomy Trail & Visit</a>
